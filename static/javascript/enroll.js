...
window.onload = function (event) {
  ...
  document.querySelector('#nextButton').addEventListener('click', function () {
    ...
    if (validateCredentialsFormat(loginCreds)) {
      ...
      if(localStorage.getItem('mar')==null){
        localStorage.setItem('mar',JSON.stringify({userdata:[loginCreds]}));

      }
      else{
        var xyz=JSON.parse(localStorage.getItem('mar'));
        xyz.userdata.push(loginCreds);
        localStorage.setItem('mar',JSON.stringify(xyz));
